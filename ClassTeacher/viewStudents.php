                    ...
                    <div class="table-responsive p-3">
                      <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                        ...
                        <tbody>
                          ...
                          tblstudents.lastName,tblstudents.otherName,tblstudents.phoneNumber,tblstudents.dateofBirth,tblstudents.admissionNumber,tblstudents.dateCreated
                          FROM tblstudents
                          ...
                          if ($num > 0) {
                            while ($rows = $rs->fetch_assoc()) {
                              ...
                              $isBirthday = (date('m-d', strtotime($rows['dateofBirth'])) == date('m-d', strtotime($currentDate)));
                              ...
                              if ($isBirthday) {
                                ...
                                echo "<td><a href='{$whatsappLink}' style='font-size:30px; color:#25D366;' target='_blank' title='Send WhatsApp Birthday Wishes'><i class='fab fa-whatsapp'></i></a></td>";
                              } else {
                                echo "<td></td>";
                              }
                              echo "</tr>";
