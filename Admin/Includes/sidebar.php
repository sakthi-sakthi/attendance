<ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsebirthday" aria-expanded="true"
      aria-controls="collapsebirthday">
      <i class="fas fa-birthday-cake"></i>
      <span>Send Birthday Wishes</span>
    </a>
    <div id="collapsebirthday" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Today's Birthday</h6>
        <a class="collapse-item" href="birthdaymail.php">View Birthday Students</a>
      </div>
    </div>
  </li>
  <hr class="sidebar-divider">
