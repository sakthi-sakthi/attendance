      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row mb-3">
            ...
            <!-- Today Birthday Students Count -->

            <?php
            $currentDate = date('Y-m-d');
            $query1 = mysqli_query($conn, "SELECT * FROM tblstudents WHERE dateofBirth = '$currentDate'");
            $tblstudents = mysqli_num_rows($query1);
            ?>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Today's Birthday</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?php echo $tblstudents; ?>
                      </div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                      </div>
                    </div>
