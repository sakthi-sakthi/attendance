...
if (isset($_POST['save'])) {
  ...
  if ($ret > 0) {
    ...
    $query = mysqli_query($conn, "insert into tblstudents(firstName,lastName,otherName,mail,dateOfBirth,phoneNumber,admissionNumber,password,classId,classArmId,dateCreated) 
    value('$firstName','$lastName','$otherName','$email','$dateOfBirth','$phoneNumber','$admissionNumber','12345','$classId','$classArmId','$dateCreated')");
...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit") {
  ...
  if (isset($_POST['update'])) {
    ...
    otherName='$otherName',mail='$email',dateOfBirth='$dateOfBirth',phoneNumber='$phoneNumber', admissionNumber='$admissionNumber',password='12345', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
    if ($query) {
                ...
                <div class="card-body">
                  <form method="post">
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-xl-6">
                        ...
                        <input type="date" class="form-control" name="dateOfBirth"
                          value="<?php echo $row['dateOfBirth']; ?>" id="exampleInputdateOfBirth">
                      </div>
                    </div>
                    <div class="form-group row mb-3">
                      <div class="col-xl-12">
                        ...
                        <input type="tel" class="form-control" name="phoneNumber" maxlength="10"
                          value="<?php echo $row['phoneNumber']; ?>" id="exampleInputphoneNumber">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-xl-6">
                        <label class="form-control-label">Class Sections<span class="text-danger ml-2">*</span></label>
                        <?php
